...
static esp_err_t green_led_handler(httpd_req_t *req) {
    ...
    const char* resp_str = "green led activated!";
    httpd_resp_send(req, resp_str, strlen(resp_str));
...
static esp_err_t red_led_handler(httpd_req_t *req) {
    ...
    const char* resp_str = "red led activated!";
    httpd_resp_send(req, resp_str, strlen(resp_str));
...
void startCameraServer() {
  ...
  // URI configuration for the buzzer activation
  httpd_uri_t green_led_uri = {
    .uri = "/green_led",        // The route for buzzer activation
    .method = HTTP_GET,               // The HTTP method (GET)
    .handler = green_led_handler,        // Handler function
    .user_ctx = NULL                  // No additional user context
#ifdef CONFIG_HTTPD_WS_SUPPORT
    ,
    .is_websocket = true,             // WebSocket support (optional)
  ...
  // URI configuration for the buzzer activation
  httpd_uri_t red_led_uri = {
    .uri = "/red_led",        // The route for buzzer activation
    .method = HTTP_GET,               // The HTTP method (GET)
    .handler = red_led_handler,        // Handler function
    .user_ctx = NULL                  // No additional user context
#ifdef CONFIG_HTTPD_WS_SUPPORT
    ,
    .is_websocket = true,             // WebSocket support (optional)
  ...
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(camera_httpd, &green_led_uri);
    httpd_register_uri_handler(camera_httpd, &red_led_uri);
